...
BEGIN TRANSACTION
GO
PRINT N'Creating [MSCreative].[student_tb]...';

GO
CREATE TABLE [MSCreative].[relationship_tb] (
...
GO
CREATE TABLE [MSCreative].[parent_tb] (
...
GO
CREATE TABLE [MSCreative].[address_tb] (
...
GO
CREATE TABLE [MSCreative].[gender_tb](
...
GO
CREATE TABLE [MSCreative].[student_tb] (
...
GO
CREATE TABLE  [MSCreative].[teacher_tb] (
  ...
  GO
CREATE TABLE  [MSCreative].[classroom_tb] (
  ...
  GO
CREATE TABLE  [MSCreative].[classteacher_tb] (
  ...
  GO
CREATE TABLE  [MSCreative].[classroomstudent_tb] (
  ...
  GO
CREATE TABLE  [MSCreative].[attendance_tb] (
  ...
  GO
CREATE TABLE  [MSCreative].[studentdiary_tb] (
  ...
  GO
CREATE TABLE [MSCreative].[diarynotes_tb] ( 
	[diarynotes_id] INT NOT NULL,
...
GO
CREATE TABLE  [MSCreative].[subjectcatagory_tb] (
...
;
GO
CREATE TABLE  [MSCreative].[subject_tb] (
...
GO
CREATE TABLE  [MSCreative].[faculty_tb] (
...
;
GO
CREATE TABLE  [MSCreative].[examtype_tb] (
...
;
GO
CREATE TABLE  [MSCreative].[exam_tb] (
...
;
GO
CREATE TABLE  [MSCreative].[examresult_tb] (
