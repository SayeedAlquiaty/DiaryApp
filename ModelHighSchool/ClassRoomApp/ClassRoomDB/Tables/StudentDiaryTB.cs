...
namespace ClassRoomDB.Tables
{
    ...
    public class StudentDiaryTB
    {
        ...
        public void SelectAllActiveRows()
        {
            string _sqlstrig = String.Format("SELECT * FROM studentdiary_tb WHERE studentdiary_date_deleted IS NULL");
